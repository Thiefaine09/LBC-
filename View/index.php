                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrer le titre de l'annonce" name="recherchetext" aria-label="Text input with dropdown button"style="padding: 10px;">
                                            <div class="input-group-append" style="padding: 10px;">
                                                <input type="submit" class="btn btn-warning" style="background-color: #1FADDA" name="recherche" value="Rechercher"  >
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="text-center">
                                    <a class="btn btn-warning" style="background-color: #1FADDA" href="<?php if(isset($uid)): ?>nvAnnonces.php <?php else: ?> /jalegreatdeal/View/connexion.php <?php endif; ?>">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="product-img-outer text-center">
                                                    <img class="product_image rounded" style="height: 250px; width: 250px" src="../<?= $tableau["photo"] ?>" alt="prduct image">
                                                </div>
                                                ...
                                                <p class="product-actual-price">
                                                    ...
                                                    <?php else: ?>
                                                    <span class="badge badge-pill badge-danger" style="border-radius: 99px;">Main propre <i class="fa-solid fa-handshake"></i></span>
                                                    <?php endif; ?>
                                                </p>
                                                <ul class="product-variation">
                                                        <?php if ($tableau["categorie"]==1): ?>
                                                        <span class="badge badge-primary">Short <i class="fa-sharp fa-solid fa-futbol"></i></span>
                                                        <?php elseif ($tableau["categorie"]==2): ?>
                                                        <span class="badge badge-warning">Jogging/Legging <i class="fa-solid fa-user-secret mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==3): ?>
                                                        <span class="badge badge-info">T-shirt <i class="fa-solid fa-rocket mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==4): ?>
                                                        <span class="badge badge-danger">Sweat<i class="fa-solid fa-feather-pointed mx-2"></i></span>
                                                        <?php else: ?>
